...
XHRMock.post(
    ...
    function(req, resp) {
        resp = resp.status(200);resp = resp.header(':status', '200').header('date', 'Thu, 17 Jan 2019 02:59:26 GMT').header('server', 'Apache-Coyote/1.1').header('access-control-allow-origin', '*').header('access-control-allow-headers', 'Origin,X-Requested-With,Content-Type,Accept').header('access-control-allow-methods', 'GET,PUT,DELETE,POST');
        resp = resp.body('{"code":1,"rspList":[{"className":"RspCommon","rspType":-31,"value":3}]}');
...
// 请求元数据
// {
//     "startedDateTime": "2019-01-17T10:59:26.239+08:00",
//     "time": 61,
//     "request": {
//         "method": "POST",
...
//             "params": [
//                 {
//                     "name": "{\"className\":\"ReqRoleEx\",\"opType\":2,\"idx\":1}",
//                     "value": ""
//                 }
//             ]
//         },
...
//             {
//                 "name": "date",
//                 "value": "Thu, 17 Jan 2019 02:59:26 GMT"
//             },
//             {
//                 "name": "server",
...
//             "size": 72,
//             "mimeType": null,
//             "text": "eyJjb2RlIjoxLCJyc3BMaXN0IjpbeyJjbGFzc05hbWUiOiJSc3BDb21tb24iLCJyc3BUeXBlIjotMzEsInZhbHVlIjozfV19",
//             "encoding": "base64"
//         },
//         "redirectURL": null,
//         "headersSize": 163,
