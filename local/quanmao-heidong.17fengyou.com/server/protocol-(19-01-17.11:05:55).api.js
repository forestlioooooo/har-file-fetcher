...
XHRMock.post(
    ...
    function(req, resp) {
        resp = resp.status(200);resp = resp.header(':status', '200').header('date', 'Thu, 17 Jan 2019 03:05:55 GMT').header('server', 'Apache-Coyote/1.1').header('access-control-allow-origin', '*').header('access-control-allow-headers', 'Origin,X-Requested-With,Content-Type,Accept').header('access-control-allow-methods', 'GET,PUT,DELETE,POST');
...
// 请求元数据
// {
//     "startedDateTime": "2019-01-17T11:05:55.887+08:00",
//     "time": 88,
//     "request": {
//         "method": "POST",
...
//             {
//                 "name": "date",
//                 "value": "Thu, 17 Jan 2019 03:05:55 GMT"
//             },
//             {
//                 "name": "server",
