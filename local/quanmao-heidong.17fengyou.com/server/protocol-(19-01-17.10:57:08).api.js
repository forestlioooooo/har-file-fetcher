...
XHRMock.post(
    ...
    function(req, resp) {
        resp = resp.status(200);resp = resp.header(':status', '200').header('date', 'Thu, 17 Jan 2019 02:57:08 GMT').header('server', 'Apache-Coyote/1.1').header('access-control-allow-origin', '*').header('access-control-allow-headers', 'Origin,X-Requested-With,Content-Type,Accept').header('access-control-allow-methods', 'GET,PUT,DELETE,POST');
...
// 请求元数据
// {
//     "startedDateTime": "2019-01-17T10:57:08.918+08:00",
//     "time": 57,
//     "request": {
//         "method": "POST",
...
//             "params": [
//                 {
//                     "name": "{\"className\":\"ReqHeart\",\"time\":1547693828}",
//                     "value": ""
//                 }
//             ]
//         },
...
//             {
//                 "name": "date",
//                 "value": "Thu, 17 Jan 2019 02:57:08 GMT"
//             },
//             {
//                 "name": "server",
