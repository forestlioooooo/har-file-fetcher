...
XHRMock.post(
    ...
    function(req, resp) {
        resp = resp.status(200);resp = resp.header(':status', '200').header('date', 'Thu, 17 Jan 2019 02:58:39 GMT').header('server', 'Apache-Coyote/1.1').header('access-control-allow-origin', '*').header('access-control-allow-headers', 'Origin,X-Requested-With,Content-Type,Accept').header('access-control-allow-methods', 'GET,PUT,DELETE,POST');
        resp = resp.body('{"code":1,"rspList":[{"className":"RspShareHeadList","list":[],"type":2}]}');
...
// 请求元数据
// {
//     "startedDateTime": "2019-01-17T10:58:39.271+08:00",
//     "time": 104,
//     "request": {
//         "method": "POST",
...
//             "params": [
//                 {
//                     "name": "{\"className\":\"ReqShare\",\"type\":2}",
//                     "value": ""
//                 }
//             ]
//         },
...
//             {
//                 "name": "date",
//                 "value": "Thu, 17 Jan 2019 02:58:39 GMT"
//             },
//             {
//                 "name": "server",
...
//             "size": 74,
//             "mimeType": null,
//             "text": "eyJjb2RlIjoxLCJyc3BMaXN0IjpbeyJjbGFzc05hbWUiOiJSc3BTaGFyZUhlYWRMaXN0IiwibGlzdCI6W10sInR5cGUiOjJ9XX0=",
//             "encoding": "base64"
//         },
//         "redirectURL": null,
//         "headersSize": 163,
