...
XHRMock.post(
    ...
    function(req, resp) {
        resp = resp.status(200);resp = resp.header(':status', '200').header('date', 'Thu, 17 Jan 2019 03:01:19 GMT').header('server', 'Apache-Coyote/1.1').header('access-control-allow-origin', '*').header('access-control-allow-headers', 'Origin,X-Requested-With,Content-Type,Accept').header('access-control-allow-methods', 'GET,PUT,DELETE,POST');
        resp = resp.body('{"code":1,"rspList":[{"className":"RspCommon","rspType":-30,"value":2}]}');
...
// 请求元数据
// {
//     "startedDateTime": "2019-01-17T11:01:19.115+08:00",
//     "time": 193,
//     "request": {
//         "method": "POST",
...
//             {
//                 "name": "date",
//                 "value": "Thu, 17 Jan 2019 03:01:19 GMT"
//             },
//             {
//                 "name": "server",
...
//             "size": 72,
//             "mimeType": null,
//             "text": "eyJjb2RlIjoxLCJyc3BMaXN0IjpbeyJjbGFzc05hbWUiOiJSc3BDb21tb24iLCJyc3BUeXBlIjotMzAsInZhbHVlIjoyfV19",
//             "encoding": "base64"
//         },
//         "redirectURL": null,
//         "headersSize": 163,
