...
XHRMock.post(
    ...
    function(req, resp) {
        resp = resp.status(200);resp = resp.header(':status', '200').header('date', 'Thu, 17 Jan 2019 03:01:39 GMT').header('server', 'Apache-Coyote/1.1').header('access-control-allow-origin', '*').header('access-control-allow-headers', 'Origin,X-Requested-With,Content-Type,Accept').header('access-control-allow-methods', 'GET,PUT,DELETE,POST');
...
// 请求元数据
// {
//     "startedDateTime": "2019-01-17T11:01:39.712+08:00",
//     "time": 74,
//     "request": {
//         "method": "POST",
...
//             "params": [
//                 {
//                     "name": "{\"className\":\"ReqWx\",\"name\":\"莫非\",\"head\":\"https://wx.qlogo.cn/mmopen/vi_32/PiajxSqBRaEKJDFymyCuwH6MyjR1ZUt1TvC9f1K6aNJuhkMQKia5lKAibAMw2XD3VkJfCBfFJvCPIWNicYHqcoSNmg/132\"}",
//                     "value": ""
//                 }
//             ]
//         },
...
//             {
//                 "name": "date",
//                 "value": "Thu, 17 Jan 2019 03:01:39 GMT"
//             },
//             {
//                 "name": "server",
