...
XHRMock.get(
    ...
    function(req, resp) {
        resp = resp.status(200);resp = resp.header(':status', '200').header('date', 'Thu, 17 Jan 2019 02:58:49 GMT').header('content-type', 'application/json; charset=utf-8').header('content-length', '11').header('x-powered-by', 'Express').header('etag', 'W/"b-o7byiMkfh0qH8CUtSWby2EGa2w8"');
...
// 请求元数据
// {
//     "startedDateTime": "2019-01-17T10:58:49.406+08:00",
//     "time": 60,
//     "request": {
//         "method": "GET",
...
//             {
//                 "name": "date",
//                 "value": "Thu, 17 Jan 2019 02:58:49 GMT"
//             },
//             {
//                 "name": "content-type",
